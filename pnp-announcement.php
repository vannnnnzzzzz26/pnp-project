    ...
    <div style="margin-top: 3rem;" class="sidebar bg-dark" id="sidebar">
        ...
        <div class="user-info px-3 py-2 text-center">
            ...
            if (isset($_SESSION['email'])) {
                ...
                echo "<p class='white-text'>$accountType</p>";
                echo "<h5 class='white-text'>$firstName $middleName $lastName $extensionName</h5>";
                echo "<p class='user-email white-text'>$email</p>";
            }
            ?>
        </div>
